...
async function measure(width, auth) {
    ...
    // 7 TAP_BESTBALL, 8 probe
    return { ran: true, arrival: v[0], image: v[3], mark: v[6], afterBestBall: v[8] };
}
...
(async () => {
    ...
    console.log(JSON.stringify({
        verdict, failures,
        measured: {
            phone: { hero: phone.arrival.hero, panelTop: phone.arrival.panel && phone.arrival.panel.top, columns: phone.arrival.pickerColumns, active: phone.arrival.active, afterBestBall: phone.afterBestBall.active, darkOnArrival: phone.arrival.dark, storedTheme: phone.arrival.storedTheme, toggleRects: phone.arrival.toggleRects, image: phone.image, mark: phone.mark, lockup: { disc: phone.arrival.discBox, rattle: phone.arrival.rattleBox, product: phone.arrival.productBox, rattleText: phone.arrival.rattleText }, scroll: [phone.arrival.scrollWidth, phone.arrival.innerWidth] },
