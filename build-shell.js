...
const PRODUCTS = {
    consumer: {
        ...
        // Moved to v63. A season ledger totals finalized Results across rounds
        // (season.html, season.js, the Game Day entry on admin.html). A device on
        ...
        cacheName: 'consumer-v77-no-card-attendance',
        appName: 'HardPan',
        shortName: 'HardPan',
