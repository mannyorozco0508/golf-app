...
function layered() {
    ...
    ['handicap.js', 'match-engine.js', 'money-engine.js', 'settlement-engine.js', 'bet-strip.js', 'hole-events.js'].forEach(f =>
        vm.runInContext(read(f), sb, { filename: f }));
    return sb;
}
const BS = layered();
const settle = loadHtmlInlineScript('settlement.html', ['handicap.js', 'match-engine.js', 'money-engine.js', 'action-model.js', 'settlement-engine.js']);
