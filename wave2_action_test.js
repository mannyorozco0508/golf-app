...
const BS = loadLayered(['handicap.js', 'action-model.js', 'match-engine.js', 'money-engine.js', 'bet-strip.js']);
...
describe('SCORECARD RENDER — the command center in a stubbed DOM', () => {
    function render(open, data, players) {
        const sb = loadHtmlInlineScript('index.html', ['handicap.js', 'action-model.js', 'match-engine.js', 'money-engine.js', 'bet-strip.js']);
        vm.runInContext(
