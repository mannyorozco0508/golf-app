...
describe('FROZEN — THIS WAS SETUP ORCHESTRATION, NOT ARITHMETIC', () => {
    ...
    const FROZEN = {
        ...
        // nets too.
        'settlement-engine.js': 'ddcbfa7521b5402bf98b3926f88d8c5266b3ba14690907561d02cd8903029746',   // re-pinned v215: the Aloha bet's three approved edits (aloha-bet.js owns the rules and the arithmetic)   // re-pinned 2026-09-22: the KP refund wording (approved); was 9043e7fc...
        // Previous hash, for the record:
        ...
        // so a trip that has rounds cannot be destroyed in one write. That is the
        // ONLY change in the file - one line, verified by diff. The behaviour it
        // buys, and the three things it deliberately does NOT buy, are pinned by
        // trip_delete_rules_test.js, which is where a reader should go: a hash
