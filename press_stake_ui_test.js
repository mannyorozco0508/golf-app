...
describe('SERVICE WORKER', () => {
    ...
    test('CACHE_VERSION moved to v11', () => {
        assert.match(sw, /const CACHE_VERSION = 'golfapp-v177-native-course-search';/);
