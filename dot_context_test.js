...
describe('SERVICE WORKER', () => {
    ...
    test('CACHE_VERSION moved', () => {
        assert.match(sw, /const CACHE_VERSION = 'golfapp-v188-paste-flight-letter';/);
