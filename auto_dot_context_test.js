...
describe('SERVICE WORKER', () => {
    ...
    test('CACHE_VERSION moved for the Rattle Golf identity batch', () => {
        assert.match(sw, /const CACHE_VERSION = 'golfapp-v166-beta-notice-gone';/);
