...
const EV = layered(['handicap.js', 'action-model.js', 'match-engine.js', 'money-engine.js', 'bet-strip.js', 'hole-events.js']);

const PAGE = ['handicap.js', 'action-model.js', 'match-engine.js', 'money-engine.js', 'settlement-engine.js', 'bet-strip.js', 'hole-events.js'];
...
describe('EARLIER WAVES PRESERVED', () => {
    ...
    test('money engines were not touched by Wave 5', () => {
        ['handicap.js', 'match-engine.js', 'money-engine.js', 'settlement-engine.js', 'action-model.js'].forEach(f => {
            const s = read(f);
